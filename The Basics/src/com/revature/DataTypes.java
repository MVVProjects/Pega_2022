...
public class DataTypes {
	...
	public void dataTypes() {
		...
		int i = 0; // Variable initialization: variables name and type are established, and it has explicit value. 32 bits in length.
		short s; // Short is 16 bits. This i called a variable declaration: name and type are established, but no value is assigned.
